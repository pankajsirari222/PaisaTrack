    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/3 md:w-1/2 bg-white border-blue-800 border-4">
        <div class="h-full flex flex-col items-center text-center">
          ...
          <div class="w-full">
            <h2 class="title-font font-medium text-lg text-gray-900">Atharva Amberkar</h2>
      ...
      <div class="p-4 lg:w-1/3 md:w-1/2 bg-white border-blue-800 border-4">
        <div class="h-full flex flex-col items-center text-center">
          ...
          <div class="w-full">
            <h2 class="title-font font-medium text-lg text-gray-900">Aastle Stephno</h2>
      ...
      <div class="p-4 lg:w-1/3 md:w-1/2 bg-white border-blue-800 border-4">
        <div class="h-full flex flex-col items-center text-center">
          ...
          <div class="w-full">
            <h2 class="title-font font-medium text-lg text-gray-900">Pankaj Sirari</h2>
            <h3 class="text-gray-500 mb-3">Frontend Developer</h3>
            <span class="inline-flex">
              <a class="text-gray-500">
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
